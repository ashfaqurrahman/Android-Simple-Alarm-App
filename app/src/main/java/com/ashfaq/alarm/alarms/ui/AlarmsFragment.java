...
package com.ashfaq.alarm.alarms.ui;
...
import com.ashfaq.alarm.alarms.data.AlarmCursor;
import com.ashfaq.alarm.alarms.data.AlarmsListCursorLoader;
import com.ashfaq.alarm.alarms.data.AsyncAlarmsTableUpdateHandler;
import com.ashfaq.alarm.alarms.misc.AlarmController;
import com.ashfaq.alarm.dialogs.TimePickerDialogController;
import com.ashfaq.alarm.list.RecyclerViewFragment;
import com.ashfaq.alarm.util.DelayedSnackbarHandler;

import static com.ashfaq.alarm.util.FragmentTagUtils.makeTag;
...
public class AlarmsFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
    ...
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "com.ashfaq.alarm.alarms.extra.SCROLL_TO_ALARM_ID";
