...
import static com.ashfaq.alarm.util.Preconditions.checkNotNull;
...
public class PendingAlarmScheduler extends BroadcastReceiver {
    ...
    public static final String EXTRA_ALARM_ID = "com.ashfaq.alarm.alarms.background.PendingAlarmScheduler.extra.ALARM_ID";
