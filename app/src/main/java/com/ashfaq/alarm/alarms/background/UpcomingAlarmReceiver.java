...
package com.ashfaq.alarm.alarms.background;
...
import static com.ashfaq.alarm.util.TimeFormatUtils.formatTime;
...
public class UpcomingAlarmReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_DISMISS_NOW = "com.ashfaq.alarm.action.DISMISS_NOW";

    public static final String ACTION_CANCEL_NOTIFICATION = "com.ashfaq.alarm.action.CANCEL_NOTIFICATION";
    public static final String ACTION_SHOW_SNOOZING = "com.ashfaq.alarm.action.SHOW_SNOOZING";
    public static final String EXTRA_ALARM = "com.ashfaq.alarm.extra.ALARM";
