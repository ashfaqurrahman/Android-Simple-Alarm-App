...
public class AlarmRingtoneService extends RingtoneService<Alarm> {
    ...
    private static final String ACTION_SNOOZE = "com.ashfaq.alarm.ringtone.action.SNOOZE";
    private static final String ACTION_DISMISS = "com.ashfaq.alarm.ringtone.action.DISMISS";
