...
package com.ashfaq.alarm.ringtone;
...
import com.ashfaq.alarm.ringtone.playback.RingtoneService;
import com.ashfaq.alarm.util.LocalBroadcastHelper;
...
public abstract class RingtoneActivity<T extends Parcelable> extends BaseActivity {
    ...
    public static final String ACTION_FINISH = "com.ashfaq.alarm.ringtone.action.FINISH";
    public static final String EXTRA_RINGING_OBJECT = "com.ashfaq.alarm.ringtone.extra.RINGING_OBJECT";
    public static final String ACTION_SHOW_SILENCED = "com.ashfaq.alarm.ringtone.action.SHOW_SILENCED";
