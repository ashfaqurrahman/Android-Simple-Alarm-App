...
package com.ashfaq.alarm.chronometer;
...
public abstract class ChronometerNotificationService extends Service {
    public static final String ACTION_START_PAUSE = "com.ashfaq.alarm.timers.action.START_PAUSE";
    public static final String ACTION_STOP = "com.ashfaq.alarm.timers.action.STOP";

    public static final String EXTRA_ACTION_ID = "com.ashfaq.alarm.extra.ID";
